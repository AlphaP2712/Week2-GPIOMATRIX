...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  //read PC10 and save it to Button1
	 GPIO_PinState Button;
	 Button = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_10);

	 //send logic form button1 to PC12
	 HAL_GPIO_WritePin(GPIOC, GPIO_PIN_12, Button);
...
//	  {
//		  //set next alarm
//		  timestamp = HAL_GetTick() + delayTime ;//ms
//
//		  //toggle led
//		  HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_5);
//
